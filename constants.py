...
NUCLEOTIDE_COMPLEMENTS = {
    ...
    SPECIAL_CHARACTER_W: (NUCLEOTIDE_A, NUCLEOTIDE_T),
    SPECIAL_CHARACTER_S: (NUCLEOTIDE_C, NUCLEOTIDE_G),
    SPECIAL_CHARACTER_M: (NUCLEOTIDE_G, NUCLEOTIDE_T),
    SPECIAL_CHARACTER_K: (NUCLEOTIDE_A, NUCLEOTIDE_C),
    SPECIAL_CHARACTER_R: (NUCLEOTIDE_C, NUCLEOTIDE_T),
    SPECIAL_CHARACTER_Y: (NUCLEOTIDE_A, NUCLEOTIDE_G),
    SPECIAL_CHARACTER_D: (NUCLEOTIDE_A, NUCLEOTIDE_C, NUCLEOTIDE_T),
    SPECIAL_CHARACTER_H: (NUCLEOTIDE_A, NUCLEOTIDE_G, NUCLEOTIDE_T),
    SPECIAL_CHARACTER_B: (NUCLEOTIDE_A, NUCLEOTIDE_C, NUCLEOTIDE_G),
    SPECIAL_CHARACTER_V: (NUCLEOTIDE_T, NUCLEOTIDE_C, NUCLEOTIDE_G),
    SPECIAL_CHARACTER_N: (NUCLEOTIDE_A, NUCLEOTIDE_C, NUCLEOTIDE_G, NUCLEOTIDE_T),
    }
